...
public class MenuKey {
    ...
    public static final String DIANXIN_SHIMIN = "DIANXIN_SHIMIN";
    public static final String YIDONG_SHIMIN = "YIDONG_SHIMIN";
    public static final String PTDJ_CARDQUERY="PTDJ_CARDQUERY";
}
