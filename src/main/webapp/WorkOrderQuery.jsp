...
<%
    ...
    String sql="SELECT .*, card_ptdj_ptinfo.PT_NAME FROM card_info_ptdj INNER JOIN card_ptdj_ptinfo ON  card_info_ptdj.PTID = card_ptdj_ptinfo.PTID where OPEN_ID='" + openid + "'";
